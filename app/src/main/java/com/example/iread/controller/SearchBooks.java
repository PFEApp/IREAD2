...
import com.example.iread.View.RecyclerViewAdapter;
                        ...
                        try {
                            ...
                            for (int i = 0 ; i< items.length() ;i++){
                                ...
                                try{
                                    ...
                                    rating = Float.parseFloat(volumeInfo.getString("averageRating"));
                                    ...
                                    for (int k=0;k<categ.length();k++) {
                                        categories = categ.getString(k)+"|"+categories;
                                    }
                                ...
                                try {
                                     ...
                                     thumbnail = "https://firebasestorage.googleapis.com/v0/b/iread-464ee.appspot.com/o/notebook.png?alt=media&token=6490b06e-4f63-4064-8abf-08d90d49d9ea";
                                }
                                ...
                                mBooks.add(new Book(title , author , publishedDate , description ,categories
                                        ,thumbnail,buy,previewLink,price,pageCount,url, rating));


                                mAdapter = new RecyclerViewAdapter(SearchBooks.this , mBooks);
